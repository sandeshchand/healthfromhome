...
import { ArrowRight, CalendarClock, FileText, HeartPulse, Plus, UserRound } from "lucide-react"
import { api } from "@/lib/api"
import { hasToken } from "@/lib/auth"
import { formatNpr } from "@/lib/format"
import type { Booking, MedicalRecord, PatientProfile } from "@/lib/types"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([patientResponse, bookingResponse, recordResponse]) => {
        ...
        {loading ? (
          ...
          <>
            <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <SummaryCard label="Completed" value={bookings.filter((booking) => booking.status === "COMPLETED").length} helper="Finished care requests" />
            </section>
